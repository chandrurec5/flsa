...
Thus \Cref{notwad} positive definiteness of $P\in \P_B$ alone is not sufficient for weak admissibility. However, when we impose additional structure in the data in the form of positive semi-definiteness,  we then observe weak admissibility in \Cref{wad}, and at the same time, it is not enough to guarantee admissibility in \Cref{notad}. Finally, when we impose structure in the form of positive definiteness we observe admissibility.
\begin{comment}
\FloatBarrier
\begin{table}[H]
