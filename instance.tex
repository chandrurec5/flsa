...
\item \textbf{Geometric Series:} In simple terms the error dynamics is akin to sum of a geometric series with common factor $\alpha\rho$, a fact that is illustrated by the simple $1$-dimensional example in \Cref{ex:geo}.
